...
{
    public class SpannerUpdateStepExecutedMarker : IUpdateStepExecutedMarker
    {
        private readonly IDatabaseService<SpannerConnection> _databaseService;
        private readonly IDatabaseServiceTransactionProvider<SpannerTransaction> _transactionProvider;
        private SpannerCommand _assemblySelect;
        private SpannerCommand _assemblyInsert;
        private SpannerCommand _versionSelect;
        private SpannerCommand _versionInsert;
        private SpannerCommand _stepSelect;
        private SpannerCommand _stepInsert;

        public SpannerUpdateStepExecutedMarker(IDatabaseService<SpannerConnection> databaseService, IDatabaseServiceTransactionProvider<SpannerTransaction> transactionProvider)
        {
        ...
        private void SetupAssemblyDbCommands()
        {
            ...
            {
                _assemblySelect = new SpannerCommand();
            ...
            {
                _assemblyInsert = new SpannerCommand();
        ...
        private void SetupVersionDbCommands()
        {
            ...
            {
                _versionSelect = new SpannerCommand();
            ...
            {
                _versionInsert = new SpannerCommand();
        ...
        private void SetupStepDbCommands()
        {
            if (_stepSelect == null)
            {
                _stepSelect = new SpannerCommand();
            ...
            if (_stepInsert == null)
            {
                _stepInsert = new SpannerCommand();
